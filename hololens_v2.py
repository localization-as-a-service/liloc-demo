...
class Visualizer(Thread):
    ...
    def draw_trajectory(self):
        trajectory = np.array([self.global_t[i][:3, 3] for i in range(len(self.global_t))])
    ...
    def append_global_t(self, t):
        self.global_t.append(t)
...
def update_visualizer_local(vis, source, transformation_matrix):
    ...
    vis.append_global_t(transformation_matrix)
